...
We found that and than in the 2-nd column we see: "Trojan:Win32/Redline!rfn". It means that Microsoft identifies the file as a Redline Trojan. And let's pay attention to the "!rfn". It's a suffix, indicating a detection option (often meaning “Cloud detection” or “ML detection”)
## Q2
...
Than we see a facebook social media. I put it in a red box.
## Q6
...
Here we see that ip: 77.91.124.55 is detected by ZenBox and C2AE. So, we can say that this ip is malicious. The answer is **77.91.124.55**,but we need to write a port. If scroll down, we will see this ip with it's port.
## Q7
...
Then we can check each dll. If check ADVAPI32.dll here we can see that this dll adjusts token privileges.
# 🏆 Key Flags
| Question | Answer |
| :--- | :--- |
| **Q1**| `Trojan` |
